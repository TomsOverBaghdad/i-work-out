...
import { WorkoutIcon } from './common/WorkoutIcon';
import { RenderExercise } from './common/ExerciseForms';
...
const StartWorkout = ({ previousWorkouts = testWorkouts }) => {
	const { state = {} } = useLocation();
	const [currentExerciseIndex, setCurrentExercise] = useState(0);
	const [selectedWorkout, setSelectedWorkout] = useState(state.workout);
		...
		return (
			<React.Fragment>
				...
				>
					...
					/>
					{/* <Divider className="workout-divider" type="horizontal" /> */}
					<WorkoutFormList
						form={form}
